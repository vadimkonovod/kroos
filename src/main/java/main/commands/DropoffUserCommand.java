...
public class DropoffUserCommand extends Command{

  private Sheets sheetsService;

  public DropoffUserCommand(TelegramBotApi telegramBotApi, Message message, Sheets sheetsService) {
  ...
  private String unregisterUser(User user) throws IOException {
    ...
    ValueRange bodyWithYesAnswer = new ValueRange().setValues(Collections.singletonList(Collections.singletonList("no")));
